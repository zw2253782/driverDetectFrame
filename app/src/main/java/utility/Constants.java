...
public class Constants {
    ...
    public static final String kDBFolder = Environment.getExternalStorageDirectory().getAbsolutePath().toString()+ "/origanalDatabases/";
    public static final String sensorDBFolder = Environment.getExternalStorageDirectory().getAbsolutePath().toString()+ "/sensorDatabases/";
